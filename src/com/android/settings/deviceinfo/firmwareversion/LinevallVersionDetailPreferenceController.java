...
public class LinevallVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "LinevallVersionDialogCtrl";
    ...
    public LinevallVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
	...
	if (!linevallVer[1].isEmpty())
	    return linevallVer[1];
	else
